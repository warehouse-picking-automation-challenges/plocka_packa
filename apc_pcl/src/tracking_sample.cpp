// Adapted from http://pointclouds.org/documentation/tutorials/tracking.php
...
void
cloud_cb (const sensor_msgs::PointCloud2ConstPtr& cloudIn ) //const CloudConstPtr &cloud)
{
  CloudPtr cloud;
